...
1. Export the WhatsApp conversation.
2. Include media when exporting.
3. Prefer the `.zip` export when you want images included.
4. Upload the original export to ChatBook.
5. Enter the book details.
6. Generate the PDF.
...
| Theme | Style |
|---|---|
| Sunset | Warm, romantic pastel |
| Cream | Soft, minimal and elegant |
| Midnight | Dark and modern |
| Rose | Romantic pink aesthetic |
